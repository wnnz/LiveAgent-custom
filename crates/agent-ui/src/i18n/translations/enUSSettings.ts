export const EN_US_SETTINGS_TRANSLATIONS = {
  ...
  "settings.agentsTitle": "Prompts & Subagent Roles",
  "settings.agentsDesc":
    "Manage parent prompts and subagent roles that AI can select automatically",
  ...
  "settings.agentsGlobalConfigHint":
    "Only one parent default can be active; multiple subagent roles can be enabled independently.",
  ...
  "settings.agentsGlobalShort": "Global",
  "settings.agentsRoleShort": "Role",
  "settings.agentsRoleBadge": "Subagent role",
  "settings.agentsRoleEnabled": "Use as subagent role",
  "settings.agentsRoleEnabledHint":
  ...
  "settings.agentsRoleModelUnavailable": "Unavailable model configuration",
  "settings.agentsRoleFallbackParent": "falls back to parent model at runtime",

export const ZH_CN_SETTINGS_TRANSLATIONS = {
  ...
  "settings.agentsTitle": "提示词与子代理角色",
  "settings.agentsDesc": "管理父对话提示词，以及可由 AI 自动选择的子代理角色",
  "settings.agentsGlobalTab": "全局模板",
  "settings.agentsProjectsTab": "项目提示词",
  "settings.agentsGlobalConfigTitle": "全局默认提示词",
  "settings.agentsGlobalConfigHint": "父对话默认一次只能启用一个；子代理角色可以独立启用多个。",
  ...
  "settings.agentsGlobalShort": "全局",
  "settings.agentsRoleShort": "角色",
  "settings.agentsRoleBadge": "子代理角色",
  "settings.agentsRoleEnabled": "用于子代理角色",
  ...
  "settings.agentsRoleModelUnavailable": "已失效的模型配置",
  "settings.agentsRoleFallbackParent": "运行时回退父模型",
